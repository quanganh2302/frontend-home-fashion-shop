...
const Header = () => {
  ...
  // useEffect(
  //   () =>
  //     (document.getElementsByName("search").placeholder =
  //       "new text for email"),
  //   [lang]
  // );
  ...
  return (
    <header className="header relative">
      ...
      {/* // Wrap header -------------------------------------- */}
      <div
        className={`header-top container-custom  flex items-center justify-between `}
      >
        {/* //Header top left------------------------------ */}
        <div
        ...
        >
          ...
          <div className={`header-men uppercase cursor-pointer hidden md:flex`}>
          ...
          <div className={`header-bag uppercase cursor-pointer hidden md:flex`}>
          ...
          <div
            className={
              isOpenMenu ? "menu-popup active-open-menu" : "menu-popup"
            }
          >
